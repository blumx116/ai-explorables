...
This article will focus on Mamba 1, but [Mamba 2's design](https://tridao.me/blog/2024/mamba2-part1-model/) <a class="citestart" key="mamba-2"></a> incorporates all of the same principles, so the lessons transfer quite seamlessly <a class="footstart" key="mamba-2-A"></a>.
